...
/**
 * 执行结果: DevilBean no arg Construct bean初始化前===========   beanName : devilBean DevilBean postConstruct DevilBean
 * afterPropertiesSet DevilBean init bean初始化后-----  beanName : devilBean
 *
 * @author Devil
