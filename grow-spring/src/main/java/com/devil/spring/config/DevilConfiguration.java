    ...
    static class Registrar implements ImportBeanDefinitionRegistrar {
        ...
        public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
            ...
            AbstractBeanDefinition beanDefinition = BeanDefinitionBuilder.genericBeanDefinition(
                            DevilBeanPostProcessor.class, DevilBeanPostProcessor::new)
                    .setRole(BeanDefinition.ROLE_INFRASTRUCTURE).getBeanDefinition();
            // 用户自定义false
            beanDefinition.setSynthetic(false);
            registry.registerBeanDefinition(BEAN_POST_PROCESSOR_NAME, beanDefinition);
            registry.registerBeanDefinition(REGISTRY_BEAN_NAME,
                    new RootBeanDefinition(DevilBeanDefinitionRegistryPostProcessor.class));
            registry.registerBeanDefinition(BEAN_FACTORY_BEAN_NAME,
                    new RootBeanDefinition(DevilBeanFactoryPostProcessor.class));
